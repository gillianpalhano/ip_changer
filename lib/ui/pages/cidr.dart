...
class _CidrMaskConverterPageState extends State<CidrMaskConverterPage> {
  ...
  void _onChanged(String origin) {
    ...
    _debounce = Timer(_delay, () {
      ...
      if (origin == 'cidr' && _cidrCtrl.text.isNotEmpty && _maskCidrKey.currentState!.validate()) {
        final mask = cidrToDotted(_cidrCtrl.text);
        _maskCtrl.text = mask;

      } else if (origin == 'mask' && _maskCtrl.text.isNotEmpty && _maskDottedKey.currentState!.validate()) {
